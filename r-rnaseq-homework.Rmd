...
[^mask]: Note that you may need to explicitly call `select()` from the dplyr library using `dplyr::select()`, because loading DESeq2 will mask dplyr's select if you loaded dplyr or tidyverse first.
